...
#onnx_output_path = "/home/tiennv/trang/ControlNeXt/ControlNeXt-SD1.5/onnx_weight/unet.onnx"

#session = ort.InferenceSession(onnx_output_path, providers=providers)
...
class UNet2DConditionModel(
    ...
    def forward(
        ...
        mid_block_additional_residual_scale: torch.Tensor,
        ...
        '''outputs = session.run(None, {'sample': sample.cpu().numpy(),
                             'timestep': timestep.cpu().numpy(),
                             'encoder_hidden_state': encoder_hidden_states.cpu().numpy(),
                             'mid_block_additional_residual': mid_block_additional_residual.cpu().numpy(),
                             'mid_block_additional_residual_scale': mid_block_additional_residual_scale.cpu().numpy()})'''
        ...
        scale = mid_block_additional_residual_scale
